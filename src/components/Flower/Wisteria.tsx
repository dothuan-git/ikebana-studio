...
export const Wisteria: React.FC<WisteriaProps> = ({
  ...
  return (
    ...
    >
      {/* Main cascading stem and branch structure */}
      <g transform={`scale(1, ${branchSize})`} transformOrigin="45 0">
        <path
      ...
      <g transform={`translate(45, 100) scale(${flowerSize}) translate(-45, -100)`}>
